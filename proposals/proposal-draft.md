...
Ryan Morrison-Westphal is a senior software developer. 
...
Redstart Works is an archival consulting firm owned and operated by Jess Farrell. Jess is an archivist and business analyst. 

Redstart Works provided business analysis and migration services for CoSA’s 2024 AMS migration. I have over 15 years of experience rooted in providing access to born digital archives, facilitating communities of practice, and advocating for archives and archivists. Recent client projects provide a foundation for CoSA’s technical development needs: In 2024-2025, I supported a collections data migration that brought several units together to tackle metadata, taxonomy, and user experience issues. The DAMS, similar to CoSA’s new AMS, did not meet the needs that the vendor team promised, so we also specified and advocated for customizations that would meet the requirements of the university’s archivists and archives community. In 2025-2026, I teamed up with Ryan to write technical specifications for five community-supported technologies, ensuring that user stories were driven by the community and specifications were detailed enough to hand off to a developer to build. I am well-versed in the needs for data to advocate for archives: I served on the Society of American Archivists Committee on Public Policy for six years, including three as Chair-Elect/Chair, served one year on my local SHRAB, and regularly spin up archival advocacy projects that rely on data about archives. 

I care deeply about building a foundation of advocacy and data support for archivists to use with leadership and external stakeholders. The data that CoSA captures could empower archivists across the USA secure resources for their work, especially if it is processed and displayed in ways that are accessible and understandable to many different stakeholders. I believe in collective action and the power of communities to provide shared resources for all. A well-designed data portal and resource center supports these goals. Community engagement is a core value, and almost all of my client projects include co-creation with communities, governance, and training. I will also likely be contracting with a state archive during CoSA’s project, and I am excited about the potential to more deeply understand the needs of state archivists while supporting implementation of technology that meets those needs.
...
| RFP-required qualification                                                        | Who covers it | Evidence          |
| --------------------------------------------------------------------------------- | ------------- | ----------------- |
| Data visualization (Tableau Public, interactive dashboards)                       | Dev (+ Archivist)  | **Dev:** Amazon (2018–2025): built and iterated internal dashboards from cloud & device metrics that drove weekly Ops decisions, bug detection, and prioritization. Berkman Klein: custom visualization for Curarium (collection-metadata search/viz) and the Internet Monitor (multi-source quantitative indicators); authored the open-source jQuery Geo map/spatial-data viz library; built government web-mapping apps at Applied Geographics. Strong custom viz incl. mapping — no Tableau by name, but ready to adopt it (the proposal also supports in-site rendering). <br><br>**Archivist:** Shapes the advocacy/comparison use cases and ensures outputs communicate to non-technical stakeholders — authored *Nature*'s "How to Make Data Open? Stop Overlooking Librarians" (2023) and runs data-driven archival advocacy projects. |
| Project management of complex projects (nonprofit/academic preferred)             | Both          | **Dev:** Technical/lead developer on complex, multi-year, multi-stakeholder builds at Harvard's Berkman Klein Center (2012–2018; academic/nonprofit research) and Amazon (2018–2025), partnering closely with dedicated PMs and researchers; at Applied Geographics designed and led junior developers on government grant projects, incl. the federally funded National Broadband Map. <br><br>**Archivist:** Community/program management as Educopia Community Facilitator (2018–2024), coordinating Educopia staff, 60+ academic institutions, and 100+ members across the Software Preservation Network and BitCurator Consortium; Co-PI on the multi-year, multi-institution BitCuratorEdu project (2018–2022); now leads migration, business-analysis, and PM engagements for universities and associations through Redstart Works. |
...
| CMS/AMS familiarity; website platform migration                                   | Both          | **Dev:** Deployed and maintained WordPress (CoSA's current stack), Drupal, and WikiMedia instances, plus the Refinery (Ruby) CMS for the Internet Monitor. Hands-on multi-platform CMS operation; GrowthZone specifics to confirm in discovery. <br><br>**Archivist:** Provided the business analysis and data preparation for CoSA's own 2024 GrowthZone AMS migration; through Redstart Works, defined requirements/integrations and tested a DAMS at an R1 university, and prepared data and trained users for an association's AMS-and-website migration; earlier, led a 30,000-record migration from an archives database into McDonald's company-wide digital repository (MS Access, OpenText DAM, Adobe DAM) and ran ContentDM and departmental websites at Avery and College of Charleston. |
...
| Strong written/oral communication; clear documentation                            | Both          | **Dev:** Authored extensively documented open-source software (jQuery Geo); ran government customer needs-assessment sessions at Applied Geographics (stakeholder-facing oral communication); translated researcher requirements into deployed systems at Berkman Klein; at Amazon, regularly presented technical designs to senior management for review and approval in formal design-review sessions. <br><br>**Archivist:** Prolific author and presenter — 15+ professional/peer-reviewed publications (incl. a 2023 *Nature* commentary) and 25+ conference talks and workshops; edited and co-wrote a community email-archiving guide and a community academic-publishing guidebook; SAA Distinguished Service (2023) and Council Exemplary Service (2024) awards. |
| Stakeholder engagement (board, retirees, volunteers, sponsors, partners)          | Archivist     | Extensive governance and stakeholder leadership — six years on SAA's Committee on Public Policy (incl. Chair-Elect/Chair) and Chair of SAA's Electronic Records Section; Chair of New England Archivists' Financial Planning Committee; co-founder of the DLF Born-Digital Access Working Group; mayor-/governor-appointed civic roles (MA State Historical Records Advisory Board; Medford Historical Commission; Malden Police Community Advisory Council). As Educopia facilitator, engaged boards, volunteers, institutional members, and external partners worldwide. |
| Focus groups & surveys                                                            | Archivist     | Designed and analyzed community surveys and user research — lead author of the DLF *Collecting User Experiences, Needs, and Desires for Accessing Born-Digital Archival Collections: Survey Analysis* (2020) and related born-digital access user studies; gathered requirements through facilitated focus groups and needs assessments across 60+ member institutions at Educopia. |
| Familiarity with archives / government / libraries / museums / records management | Archivist     | 15+ years across the field with an MLIS (University of South Carolina, 2011) — roles spanning a law-school library (Harvard, incl. institutional records management and a web-archiving pilot), global corporate archives (McDonald's), and university/cultural special collections (College of Charleston; Avery Research Center for African American History and Culture, incl. 3-D museum-object digitization). Active government/records engagement via state and municipal boards (MA SHRAB; historical commissions) and SAA public-policy advocacy. |
...
| RFP-required qualification (Phase 2)                                              | Who covers it | Evidence          |
| --------------------------------------------------------------------------------- | ------------- | ----------------- |
| Strong written/oral communication; clear, concise user documentation             | Both          | **Dev:** Authored extensively documented open-source software (jQuery Geo); ran government customer needs-assessment sessions at Applied Geographics; translated researcher requirements into deployed systems at Berkman Klein; at Amazon, regularly presented technical designs to senior management in formal design-review sessions. <br><br>**Archivist:** Extensive professional writing and user-facing documentation — co-wrote/edited a community email-archiving guide, a community academic-publishing guidebook, and the BitCurator educator guide; 15+ publications and 25+ talks/workshops translating complex technical concepts for non-technical archival audiences. |
| Developing training materials & instructing diverse audiences                     | Both          | **Dev:** authored user-facing docs and API guides for open-source software (jQuery Geo) and maintainer runbooks; conducted hands-on customer training/needs sessions at Applied Geographics. <br><br>**Archivist:** Training development is a core practice — building a digital-forensics training curriculum and BitCuratorEdu open learning modules (Co-PI, 2018–2022); delivers inclusive facilitation and project-management trainings for communities of practice; trained users on a new AMS and onboarded staff to new DAM systems; 25+ workshops and webinars, including born-digital access "bootcamps." |
| Website maintenance, content management & data visualization tools                | Dev (+ Archivist)  | **Dev:** Deployed and maintained WordPress (CoSA's current stack), Drupal, WikiMedia, and the Refinery (Ruby) CMS over multi-year periods; built and iterated interactive dashboards from cloud/device metrics at Amazon (2018–2025) and custom visualization at Berkman Klein (Curarium, Internet Monitor). Tableau adoption ready (see Phase 1). <br><br>**Archivist:** Managed departmental websites and blogs and digital content (McDonald's, Avery, College of Charleston), ran ContentDM digital collections and digital-preservation activities, and curated digital collections at Harvard Law School Library. |
...
| Collecting & integrating user feedback to improve tools                           | Both          | **Dev:** iterated internal dashboards at Amazon directly from Ops feedback; ran needs-assessment sessions to shape government web apps at Applied Geographics. <br><br>**Archivist:** Ran community user research and fed it back into tools and services — DLF born-digital access user surveys and analysis (2020); co-designed Educopia program/service redesigns from member feedback; gathered and incorporated requirements from 60+ member institutions. |
| Strong project management; works independently and as part of a team              | Both          | **Dev:** Technical/lead developer on complex, multi-year, multi-stakeholder builds at Harvard's Berkman Klein Center (2012–2018) and Amazon (2018–2025), partnering with dedicated PMs; led junior developers on government grant projects at Applied Geographics, incl. the federally funded National Broadband Map. <br><br>**Archivist:** Independent consultant (Redstart Works) leading migration, business-analysis, and PM engagements, plus team-based community facilitation at Educopia coordinating 60+ institutions and 100+ members; Co-PI on the multi-year BitCuratorEdu project. |
| Community building & engagement (esp. nonprofit/archival)                         | Archivist     | Community building is her core practice — facilitated the Software Preservation Network and BitCurator Consortium at Educopia (2018–2024), sustaining 60+ institutional and 100+ individual members worldwide; co-founded the DLF Born-Digital Access Working Group; sustained record of nonprofit/archival volunteer leadership (SAA, New England Archivists, regional associations); NDSA Excellence Award for Sustainability (2021). |
| CMS/AMS familiarity; optimizing websites to new platforms                         | Both          | **Dev:** Deployed and maintained WordPress (CoSA's current stack), Drupal, and WikiMedia instances, plus the Refinery (Ruby) CMS for the Internet Monitor; hands-on multi-platform CMS operation; GrowthZone specifics to confirm in discovery. <br><br>**Archivist:** Provided business analysis and data prep for CoSA's 2024 GrowthZone AMS migration; through Redstart Works, defined requirements and tested a DAMS at an R1 university and prepared data and trained users for an association's AMS-and-website migration; earlier led a 30,000-record migration into McDonald's company-wide digital repository (MS Access, OpenText DAM, Adobe DAM). |
| Stakeholder engagement (board, retirees, volunteers, sponsors, partners)          | Archivist     | Extensive governance and stakeholder leadership — six years on SAA's Committee on Public Policy (incl. Chair-Elect/Chair) and Chair of SAA's Electronic Records Section; Chair of New England Archivists' Financial Planning Committee; co-founder of the DLF Born-Digital Access Working Group; mayor-/governor-appointed civic roles (MA State Historical Records Advisory Board; Medford Historical Commission; Malden Police Community Advisory Council). As Educopia facilitator, engaged boards, volunteers, institutional members, and external partners worldwide. |
| Familiarity with archives / government / libraries / museums / records management | Archivist     | 15+ years across the field with an MLIS (University of South Carolina, 2011) — roles spanning a law-school library (Harvard, incl. institutional records management and a web-archiving pilot), global corporate archives (McDonald's), and university/cultural special collections (College of Charleston; Avery Research Center for African American History and Culture, incl. 3-D museum-object digitization). Active government/records engagement via state and municipal boards (MA SHRAB; historical commissions) and SAA public-policy advocacy. |
| Eligible to work in the U.S.                                                      | Both          | Yes — both team members are U.S. work-eligible. |
...
- We intentionally minimize recurring costs so the finite grant buys *building and durability*, not perpetual rent.
...
9. May we have access to the **prior GitHub mock-up** and AVP's POC datasets/Tableau workbooks?
